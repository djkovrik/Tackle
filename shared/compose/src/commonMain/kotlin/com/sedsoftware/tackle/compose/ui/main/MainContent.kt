...
internal fun MainContent(
    ...
    val activeTab: MainScreenTab = when (activeComponent) {
        is MainComponent.Child.HomeTab -> MainScreenTab.HOME
        is MainComponent.Child.ExploreTab -> MainScreenTab.EXPLORE
        is MainComponent.Child.PublicationsTab -> MainScreenTab.PUBLICATIONS
        is MainComponent.Child.NotificationsTab -> MainScreenTab.NOTIFICATIONS
        is MainComponent.Child.ProfileTab -> MainScreenTab.PROFILE
    }
