...
class EditorAttachmentsComponentPreview(
    ...
    override fun onFilesSelect(files: List<PlatformFile>) = Unit
    override fun onWrappedFilesSelect(files: List<PlatformFileWrapper>) = Unit
    override fun onFileDelete(id: String) = Unit
